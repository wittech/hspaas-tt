...
public class RabbitMqConfiguration {
     ...
     * 彩信队列交互器
     */
    private static final String EXCHANGE_MMS           = "hspaas.mms";
    ...
    public AmqpAdmin amqpAdmin(@Qualifier("connectionFactory") ConnectionFactory connectionFactory) {
        ...
        Binding smsWaitReceiptBinding = BindingBuilder.bind(smsWaitReceiptQueue).to(exchange).with(MQ_SMS_MT_WAIT_RECEIPT);
