...
public class MmsHttpSender {
     ...
     * @return
     */
    public List<ProviderSendResponse> post(MmsPassageParameter parameter, String mobile, String content,
                                           String extNumber) {
     ...
     * @return
     */
    private List<ProviderSendResponse> sendCustomTranslate(MmsPassageParameter parameter, String mobile,
     ...
     * @return
     */
    public List<MmsMtMessageDeliver> deliver(SmsPassageAccess access) {
     ...
     * @return
     */
    private List<MmsMtMessageDeliver> customStatusTranslate(SmsPassageAccess access, TParameter tparameter) {
    ...
    private List<MmsMtMessageDeliver> customStatusTranslate(JSONObject report, TParameter tparameter, String successCode) {
        return AbstractPassageResolver.getInstance(tparameter.customPassage()).mtDeliver(report.getString(ParameterFilterContext.PARAMETER_NAME_IN_STREAM),
                                                                                         successCode);
    }
     ...
     * @return
     */
    private List<MmsMoMessageReceive> customMoTranslate(SmsPassageAccess access, TParameter tparameter) {
    ...
    private List<MmsMoMessageReceive> customMoTranslate(JSONObject report, TParameter tparameter, Integer passageId) {
        return AbstractPassageResolver.getInstance(tparameter.customPassage()).moReceive(report.getString(ParameterFilterContext.PARAMETER_NAME_IN_STREAM),
                                                                                         passageId);
    }
     ...
     * @return
     */
    public List<MmsMoMessageReceive> mo(SmsPassageAccess access, JSONObject report) {
        TParameter tparameter = RequestTemplateHandler.parse(access.getParams());
        if (StringUtils.isNotEmpty(tparameter.customPassage())) {
     ...
     * @return
     */
    public List<MmsMoMessageReceive> mo(SmsPassageAccess access) {
        TParameter tparameter = RequestTemplateHandler.parse(access.getParams());
        if (StringUtils.isNotEmpty(tparameter.customPassage())) {
