...
public class OpenApiCode {
    ...
    public enum ApiReponseCode {
        SUCCESS("0", "成功"), REQUEST_EXCEPTION("101", "必填项为空"), 
            APPKEY_INVALID("103", "应用不存在"), TEMPLATE_INVALID("104", "模板不存在"),
            AUTHENTICATION_FAILED("108", "签名验证失败"), MOBILE_INVALID("109", "无效手机号"), 
            SERVER_EXCEPTION("110", "系统异常"), TIMESTAMP_EXPIRED("112", "时间戳相差过大"), 
            IP_ILLEGAL("114", "IP鉴权不通过"),  TEMPLATE_SIGN_NOT_MATCHED("122", "模版签名长度不合法，必须为3～8个字"),
