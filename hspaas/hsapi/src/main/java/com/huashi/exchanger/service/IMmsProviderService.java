...
public interface IMmsProviderService {
     ...
     */
    List<ProviderSendResponse> sendMms(MmsPassageParameter parameter, String mobile, String content, Integer fee,
     ...
     * @return
     */
    List<SmsMtMessageDeliver> pullStatusReport(SmsPassageAccess access);
