...
public class GoogleAuthenticator {
    ...
    public static final String SEED                    = "Hihjk3WMQMs2lAqq1CmpYGbD55VPQ6vdZ1dk93TvZkoFc8wZ62o0oadIVr9S2n8YAu91j9G5AJ94";

    public static final String RANDOM_NUMBER_ALGORITHM = "SHA1PRNG";

    int                        window_size             = 3;                                                                             // default
                                                                                                                                         // 3
                                                                                                                                         // -
                                                                                                                                         // max
                                                                                                                                         // 17
    ...
    public static String genSecret() {
        ...
        String qrCode = GoogleAuthenticator.getQRBarcodeURL("zhengying", "hspaas.cn", secret);
        return qrCode;
    }
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(DigestUtils.sha256(SEED.getBytes()));
        System.out.println(GoogleAuthenticator.genSecret());
    }
}
