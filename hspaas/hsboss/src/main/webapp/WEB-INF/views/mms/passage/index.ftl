...
<html lang="en">
                            ...
                            <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<#if editCheck>
                                        		<a class="btn btn-primary btn-xs" href="${BASE_PATH}/mms/passage/edit?id=${pl.id}"><i class="fa fa-edit"></i>&nbsp;编辑 </a>
                                        	</#if>
                                        	&nbsp;
                                        	<#if deleteCheck>
	...
	<script type="text/javascript">
		function jumpPage(p){
			$('#pn').val(p);
			$('#myform').attr('action','${BASE_PATH}/mms/passage/index');
			$('#myform').submit();
		}
		...
		function deleteById(id){
			Boss.confirm("确定要删除该通道吗？",function(){
				$.ajax({
					url:'${BASE_PATH}/mms/passage/delete',
					type:'post',
					dataType:'json',
					data:{id:id},
		...
		function disabled(id,flag){
            ...
            Boss.confirm('确定要'+msg+'该通道吗？',function(){
                $.ajax({
                    url:'${BASE_PATH}/mms/passage/disabled',
                    type:'post',
                    dataType:'json',
		...
		function sendTestmms(){
            ...
            $.ajax({
                url:'${BASE_PATH}/mms/passage/test',
