                    ...
                    <form id="myform" class="form-horizontal">
                        <div class="panel-body">
                            ...
                            <div id="group_0" class="groupConfig">
                                ...
                                <#assign routeType = 0>
                                <#include "/WEB-INF/views/mms/passage_group/province_cmcp_table.ftl">
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.selectPassage').click(function(){
            ...
            $.ajax({
                url:'${BASE_PATH}/mms/passage_group/passageList',
    ...
    function formSubmit(){
        ...
        $.ajax({
            url:'${BASE_PATH}/mms/passage_group/create',
            dataType:'json',
            ...
            success:function(data){
                if(data.result){
                    Boss.alertToCallback('新增通道组成功！',function(){
                        location.href = "${BASE_PATH}/mms/passage_group"
                    });
                }else{
