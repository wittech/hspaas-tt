                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <#if pl.isTemplateError()>
                                        <a href="${BASE_PATH }/mms/message_template/create?sid=${pl.sid}&taskId=${pl.id}"
                                           class="btn btn-success btn-xs">模板报备</a>
                                    </#if>
                                    <#if pl.isWordError()>
                                        <a  href="${BASE_PATH }/mms/message_template/edit?id=${pl.messageTemplateId}&sid=${pl.sid}&taskId=${pl.id}"
...
<script type="text/javascript">
    ...
    function taskPass(childId){
        Boss.confirm('确定要强制通过吗？',function(){
            $.ajax({
                url:'${BASE_PATH}/mms/record/pass_task',
    ...
    function openPassageList(childId,cmcp){
        $.ajax({
            url:'${BASE_PATH}/mms/record/passage_list',
            data:{cmcp:cmcp},
            type:'post',
            dataType:'json',
            success:function(data){
    ...
    function saveFinalPassage(){
        ...
        $.ajax({
            url:'${BASE_PATH}/mms/record/update_passage',
