...
<head>
    <meta charset="utf-8">
    <title>短信模板添加 - 短信平台 - 华时融合平台</title>
...
<div style="margin: 0;">
    ...
    <form class="layui-form" action="">
                    ...
                    <div class="layui-div-left">
                        <div>
                            ...
                            <div class="layui-input-block">
                                <textarea id="content" name="content" placeholder="请输入模板内容" lay-verify="required" class="layui-textarea"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="layui-form-button">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="sendSms">保存</button>
...
<script type="text/javascript" src="/static/js/sms/send_sms.js?v=2018122015002"></script>
</body>
